        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-footer">
                    <small><b>Note:</b> You can only register as a normal user who doesn't have any functionality. If you want to register as a parent, student or faculty then please contact the admin of the page or the principal.</small>
                </div>
            </div>
        </div>
    </div>
