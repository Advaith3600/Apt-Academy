...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	mounted: function mounted() {
		if (this.subject != '') {
			this.subject = this.select.split(',');
		}
	}
});
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", [
    _vm.standard != 0 && _vm.standard < 15
      ? _c("div", { staticClass: "form-group" }, [
          ...
          _c(
            ...
            [
              _vm.standard == 8 || _vm.standard == 9 || _vm.standard == 10
                ? [
                    _c("input", {
                      directives: [
                        {
                      ...
                      domProps: {
                        checked: Array.isArray(_vm.subject)
                          ? _vm._i(_vm.subject, "All Subject") > -1
                          : _vm.subject
                      },
                      on: {
                    ...
                    _c(
                      "label",
                      { staticClass: "ml-1 mb-0", attrs: { for: "all" } },
                      [_vm._v("All Subject")]
                    )
                  ]
                : _vm._e(),
              ...
              _vm.standard == 14
                ? [
                    ...
                    _c(
                      "label",
                      { staticClass: "ml-1 mb-0", attrs: { for: "maths" } },
                      [_vm._v("Maths")]
                    )
                  ]
                : _vm._e(),
              _vm._v(" "),
              _vm.standard == 1 || _vm.standard == 2 || _vm.standard == 3
                ? [
                    _c("input", {
                      directives: [
                        {
                    ...
                    _c(
                      "label",
                      { staticClass: "ml-1 mb-0", attrs: { for: "science" } },
                      [_vm._v("Science")]
                    )
                  ]
                : _vm._e(),
              ...
              _vm.standard == 13
                ? [
                    ...
                    _c(
                      "label",
                      { staticClass: "ml-1 mb-0", attrs: { for: "biology" } },
                      [_vm._v("Biology")]
                    ),
                    _vm._v(" "),
                    _c("input", {
                    ...
                    _c(
                      "label",
                      { staticClass: "ml-1 mb-0", attrs: { for: "physics" } },
                      [_vm._v("Physics")]
                    ),
                    _vm._v(" "),
                    _c("input", {
                      ...
                      domProps: {
                        checked: Array.isArray(_vm.subject)
                          ? _vm._i(_vm.subject, "Chemistry") > -1
                          : _vm.subject
                      },
                      on: {
                        change: function($event) {
                    ...
                    _c(
                      "label",
                      { staticClass: "ml-1 mb-0", attrs: { for: "chemistry" } },
                      [_vm._v("Chemistry")]
                    ),
                    _vm._v(" "),
                    _c("input", {
                    ...
                    _c(
                      "label",
                      { staticClass: "ml-1 mb-0", attrs: { for: "computer" } },
                      [_vm._v("Computer")]
                    )
                  ]
                : _vm._e()
